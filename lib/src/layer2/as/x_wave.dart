...
class ThreeWave<A, B, C> {
    ...
    Wave<Z> latest<Z>(Z Function(A, B, C) map) => Wave.combineLatest3(a, b, c, map);
}
...
class FourWave<A, B, C, D> {
    ...
    Wave<Z> latest<Z>(Z Function(A, B, C, D) map) => Wave.combineLatest4(a, b, c, d, map);
}
...
class FiveWave<A, B, C, D, E> {
    ...
    SixWave<A, B, C, D, E, Z> and<Z>(Wave<Z> other) => SixWave(a, b, c, d, e, other);

    Wave<Z> latest<Z>(Z Function(A, B, C, D, E) map) => Wave.combineLatest5(a, b, c, d, e, map);
}
...
class EightWave<A, B, C, D, E, F, G, H> {
    ...
    const EightWave(this.a, this.b, this.c, this.d, this.e, this.f, this.g, this.h);
...
class NineWave<A, B, C, D, E, F, G, H, I> {
    ...
    const NineWave(this.a, this.b, this.c, this.d, this.e, this.f, this.g, this.h, this.i);
